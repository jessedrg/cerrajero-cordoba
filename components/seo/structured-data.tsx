// Company constants
const COMPANY_NAME = "Cerrajero Córdoba 24H"
const COMPANY_PHONE = "+34900433189"
const COMPANY_URL = "https://www.cerrajerocordoba.es"
...
export function generateLocalBusinessJsonLd(data: LocalBusinessData) {
  const schema: Record<string, unknown> = {
    ...
    "sameAs": [
      "https://www.facebook.com/cerrajerocordoba24h",
      "https://www.instagram.com/cerrajerocordoba24h"
    ],
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
...
export function generateOrganizationJsonLd() {
  return {
    ...
    "logo": `${COMPANY_URL}/logo.jpg`,
    "telephone": COMPANY_PHONE,
    "email": "info@cerrajerocordoba.es",
    "address": {
      "@type": "PostalAddress",
      "addressCountry": "ES"
    },

...
export function ServiceCityPage({ 
  ...
  return (
    <>
      ...
      <StructuredData
        localBusiness={{
          name: `Cerrajero Córdoba 24H - ${service.name} en ${cityData.name}`,
          description: page.meta_description,
          serviceName: service.name,
          cityName: cityData.name,
          latitude: cityData.latitude,
          longitude: cityData.longitude,
          telephone: "+34900433189",
        ...
        service={{
          ...
          provider: "Cerrajero Córdoba 24H",
          ...
          {introEnabled && page.intro_text && (
            <section className={cn(sectionSpacing)}>
              <div className={cn("mx-auto", contentWidth)}>
                ...
                <div 
                  className="prose prose-lg max-w-none prose-headings:text-foreground prose-p:text-muted-foreground prose-strong:text-foreground prose-a:text-orange-600 hover:prose-a:text-orange-700"

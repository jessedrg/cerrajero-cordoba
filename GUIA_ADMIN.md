# Guía de Administración - Cerrajero Córdoba 24H pSEO
...
```bash
# Ver estadísticas
curl "https://www.cerrajerocordoba.es/api/admin/generate-pages?secret=TU_CRON_SECRET"

# Generar 5 páginas
curl -X POST "https://www.cerrajerocordoba.es/api/admin/generate-pages?count=5&secret=TU_CRON_SECRET"

# Generar 10 páginas
curl -X POST "https://www.cerrajerocordoba.es/api/admin/generate-pages?count=10&secret=TU_CRON_SECRET"
```
...
curl -H "Authorization: Bearer TU_CRON_SECRET" \
  "https://www.cerrajerocordoba.es/api/admin/generate-pages"

# Generar 5 páginas
curl -X POST -H "Authorization: Bearer TU_CRON_SECRET" \
  "https://www.cerrajerocordoba.es/api/admin/generate-pages?count=5"
```
...
{
  // === TÍTULOS ===
  "title_override": "Fontanero Madrid 24h - Urgencias | Cerrajero Córdoba 24H",
  "meta_title": "Fontanero en Madrid - Servicio Urgente 24 horas",
  
  // === DESCRIPCIONES ===
  "meta_description_override": "Fontaneros profesionales en Madrid. Llama al 90043318989...",
  ...
  // === INDEXACIÓN ===
  "canonical_url": "https://www.cerrajerocordoba.es/fontanero/madrid",
  "no_index": false,
  "no_follow": false,
...
curl -X POST "https://www.cerrajerocordoba.es/api/admin/generate-pages?count=10&secret=TU_SECRET"
```
...
El teléfono 90043318989 está hardcodeado en:
...
# Sitio
NEXT_PUBLIC_SITE_URL=https://www.cerrajerocordoba.es
```

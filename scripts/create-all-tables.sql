-- ============================================
-- CERRAJERO CÓRDOBA - Script Unificado de Base de Datos
-- ============================================
-- Este script crea todas las tablas necesarias para el proyecto Cerrajero Córdoba
...
VALUES 
  ('general', '{"site_name": "Cerrajero Córdoba 24H", "phone": "900433189", "whatsapp": "34711267223", "email": "info@cerrajerocordoba.es"}'::jsonb),
  ('seo', '{"default_title_suffix": "| Cerrajero Córdoba 24H", "default_description": "Servicio profesional de cerrajería urgente en Córdoba y provincia. 24 horas, 365 días."}'::jsonb),
  ('design', '{"primary_color": "blue", "font_family": "Inter"}'::jsonb)

...
export default function NuevaPaginaPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    show_map: true,
    // CTA config
    phone_number: "900433189",
    phone_display: "900 433 189",
    cta_button_text: "",
      ...
      const res = await adminFetch("/api/admin/pages", {
        ...
        body: JSON.stringify({
          ...
          layout_config: {
            ...
            cta_config: {
              phone_number: formData.phone_number || "900433189",
              phone_display: formData.phone_display || "900 433 189",
              button_text: formData.cta_button_text || formData.phone_display || "900 433 189",
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          {combinationWarning && (
            <span className="text-sm text-orange-600 self-center mr-2">
                    ...
                    <div className="bg-orange-50 p-4 rounded-lg space-y-3">
                      <div className="flex gap-2">
                        <span className="bg-orange-500 text-white px-4 py-2 rounded-lg text-sm font-medium">
                          {formData.cta_button_text || formData.phone_display || "900 433 189"}
                        </span>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={handleChange}
                      placeholder="Fontaneros Madrid 24h - Urgencias | Cerrajero Córdoba 24H"
                    />
                    <p className="text-xs text-muted-foreground">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={handleChange}
                      placeholder="Fontaneros profesionales en Madrid. Llama al 900 433 189..."
                    />
                    <p className="text-xs text-muted-foreground">
                  ...
                  <div className="border rounded-lg p-4 bg-muted/50">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-green-700 text-sm">
                        www.cerrajerocordoba.es/{formData.slug || "slug-de-pagina"}
                      </p>
              ...
              {formData.slug && (
                <div className="p-3 bg-muted rounded-lg">
                  ...
                  <p className="text-sm font-mono break-all">
                    www.cerrajerocordoba.es/{formData.slug}
                  </p>
                </div>
              )}
            </CardContent>

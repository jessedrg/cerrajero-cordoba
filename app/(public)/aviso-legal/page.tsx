...
export const metadata: Metadata = {
  title: "Aviso Legal",
  description: "Aviso legal y condiciones de uso de Cerrajero Córdoba 24H - Servicios del hogar en toda España.",
}
  ...
  return (
    <main className="min-h-screen py-20 bg-gradient-to-b from-orange-50/50 to-background">
      <div className="container mx-auto px-4 max-w-4xl">
        <h1 className="text-4xl font-bold mb-8 text-zinc-900">Aviso Legal</h1>
        
        <div className="prose max-w-none space-y-8 bg-white rounded-2xl p-8 shadow-sm border border-orange-100">
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-zinc-800">1. Datos Identificativos</h2>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              <li><strong>Denominación social:</strong> Cerrajero Córdoba 24H</li>
              <li><strong>Dominio web:</strong> www.cerrajerocordoba.es</li>
              <li><strong>Teléfono:</strong> 900 433 189</li>
              <li><strong>Email:</strong> info@cerrajerocordoba.es</li>
              <li><strong>Actividad:</strong> Servicios de reparación y mantenimiento del hogar</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4 text-zinc-800">2. Objeto</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-zinc-800">3. Condiciones de Uso</h2>
            <p className="text-muted-foreground mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-zinc-800">4. Propiedad Intelectual</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-zinc-800">5. Exclusión de Responsabilidad</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-zinc-800">6. Legislación Aplicable</h2>
            <p className="text-muted-foreground">
          ...
          <section>
            <h2 className="text-2xl font-semibold mb-4 text-zinc-800">7. Contacto</h2>
            <p className="text-muted-foreground">
              Para cualquier consulta relacionada con este aviso legal, puede contactar con nosotros a través del teléfono <strong>900 433 189</strong> o enviando un email a <strong>info@cerrajerocordoba.es</strong>.
            </p>
          </section>

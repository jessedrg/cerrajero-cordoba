  ...
  return (
    <main className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight text-balance">
              <span className="text-orange-500">Cerrajero Córdoba 24H</span> - Profesionales de Confianza para tu Hogar
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              <Button size="lg" asChild className="gap-2 text-base bg-orange-500 hover:bg-orange-600">
                  ...
                  <Card className="h-full hover:shadow-lg transition-all hover:-translate-y-1 group cursor-pointer">
                    <CardHeader>
                      <div className="flex items-center gap-4">
                        <div className="p-3 rounded-xl bg-orange-100 text-orange-600 group-hover:bg-orange-500 group-hover:text-white transition-colors">
      ...
      <section id="contacto" className="py-20">
        <div className="container mx-auto px-4">
          <div className="rounded-2xl bg-gradient-to-r from-orange-500 to-orange-600 p-8 lg:p-12 text-white text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" variant="secondary" asChild className="gap-2 text-base bg-white text-orange-600 hover:bg-gray-100">
                <a href={`tel:+34${PHONE_NUMBER}`}>
                  <Phone className="h-5 w-5" />
                  Llamar Ahora
                </a>

...
export const metadata: Metadata = {
  title: "Electricista 24 Horas | Servicio Urgente en Toda España | Cerrajero Córdoba 24H",
  description: "Electricista profesional 24 horas. Reparacion de averias, cortocircuitos, instalaciones electricas, boletines. Llama al 900 433 189.",
}

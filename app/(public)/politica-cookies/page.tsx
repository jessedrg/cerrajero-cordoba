...
export const metadata: Metadata = {
  ...
  description: "Política de cookies de Cerrajero Córdoba 24H - Información sobre el uso de cookies en nuestro sitio web.",
}
        ...
        <div className="prose max-w-none space-y-8 bg-white rounded-2xl p-8 shadow-sm border border-orange-100">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <li><a href="https://support.mozilla.org/es/kb/habilitar-y-deshabilitar-cookies-sitios-web-rastrear-preferencias" target="_blank" rel="noopener noreferrer" className="text-orange-500 hover:underline">Mozilla Firefox</a></li>
              <li><a href="https://support.apple.com/es-es/guide/safari/sfri11471/mac" target="_blank" rel="noopener noreferrer" className="text-orange-500 hover:underline">Safari</a></li>
              <li><a href="https://support.microsoft.com/es-es/microsoft-edge/eliminar-las-cookies-en-microsoft-edge-63947406-40ac-c3b8-57b9-2a946a29ae09" target="_blank" rel="noopener noreferrer" className="text-orange-500 hover:underline">Microsoft Edge</a></li>
            </ul>
          </section>

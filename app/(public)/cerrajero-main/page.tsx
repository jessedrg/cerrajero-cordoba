...
export const metadata: Metadata = {
  title: "Cerrajero 24 Horas | Servicio Urgente en Toda España | Cerrajero Córdoba 24H",
  description: "Cerrajero profesional 24 horas. Abrimos puertas sin romper, cambio de cerraduras, bombillos de seguridad. Llegamos en 15-30 min. Llama al 900 433 189.",
}

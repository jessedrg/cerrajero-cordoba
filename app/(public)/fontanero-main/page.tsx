...
export const metadata: Metadata = {
  title: "Fontanero 24 Horas | Servicio Urgente en Toda España | Cerrajero Córdoba 24H",
  description: "Fontanero profesional 24 horas. Reparacion de fugas, desatascos, instalacion de sanitarios. Llama al 900 433 189.",
}

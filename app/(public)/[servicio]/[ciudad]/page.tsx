...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!page) {
    return {
      title: "Página no encontrada | Cerrajero Córdoba 24H",
  ...
  const defaultTitle = `${serviceName} en ${cityName} | Cerrajero Córdoba 24H - ${PHONE_DISPLAY}`
  ...
  return {
    ...
    authors: seoConfig.author ? [{ name: seoConfig.author }] : [{ name: "Cerrajero Córdoba 24H" }],
    creator: "Cerrajero Córdoba 24H",
    publisher: "Cerrajero Córdoba 24H",
      ...
      images: imageUrl ? [
        {
          ...
          width: 1200,
          height: 630,
          alt: `${serviceName} en ${cityName} - Cerrajero Córdoba 24H`,
        }
      ] : undefined,
    },
    twitter: {
      ...
      creator: "@CerrajeroCordoba",
      site: "@CerrajeroCordoba",
    },
    alternates: {
...
export default async function ServiceCityPageRoute({ params }: PageProps) {
  ...
  const page = {
    ...
    h1: pageData.h1 || `${service.name} en ${city.name}`,

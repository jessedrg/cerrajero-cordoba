...
export const metadata: Metadata = {
  ...
  description: "Política de privacidad de Cerrajero Córdoba 24H - Información sobre el tratamiento de datos personales.",
}
        ...
        <div className="prose max-w-none space-y-8 bg-white rounded-2xl p-8 shadow-sm border border-orange-100">
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              ...
              <li><strong>Web:</strong> www.cerrajerocordoba.es</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground mt-4">
              Para ejercer estos derechos, puede contactar con nosotros enviando un email a <strong>info@cerrajerocordoba.es</strong> o llamando al <strong>900 433 189</strong>.
            </p>
          </section>
